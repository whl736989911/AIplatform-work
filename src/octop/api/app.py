...
def build_app(server: OctopServer) -> FastAPI:
    ...
    _mount_routers(
        ...
        [
            ...
            _RouterMount(workbuddy_workflows.router, "/api/v1", ["workbuddy"]),
            _RouterMount(workbuddy_runtime.router, "/api/v1", ["workbuddy"]),
            _RouterMount(workbuddy_knowledge.router, "/api/v1", ["workbuddy"]),
            _RouterMount(workbuddy_proposals.router, "/api/v1", ["workbuddy"]),
            _RouterMount(workbuddy_marketplace.router, "/api/v1", ["workbuddy"]),
            _RouterMount(workbuddy_lifecycle.router, "/api/v1", ["workbuddy"]),
