"""WorkBuddy executions, step/edge runs, approvals, reconciliation, jobs, and notifications.
...
currently exposes no routes: the implementation lands on ``feat/workbuddy-a3-runtime`` (Group 1)
together with migration ``018_workbuddy_runtime``, and replaces this file wholesale.
