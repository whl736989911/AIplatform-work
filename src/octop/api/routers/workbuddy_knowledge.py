"""WorkBuddy knowledge bases, ACL, bound uploads, and trigger registrations.
...
currently exposes no routes: the implementation lands on ``feat/workbuddy-a3-knowledge`` (Group 2)
together with migration ``019_workbuddy_knowledge_triggers``, and replaces this file wholesale.
