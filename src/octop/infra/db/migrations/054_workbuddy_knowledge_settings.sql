-- Schema v54: knowledge-base settings and per-member preferences — SQLite marker.
--
-- The WorkBuddy knowledge tables are PostgreSQL only, so the per-base cap column
-- and the per-member preference table are applied on PostgreSQL alone. This file
-- creates nothing on SQLite on purpose.
--
...
-- of serving settings it cannot isolate.
--
